...
<body class="bg-gray-50 text-gray-800 transition-colors duration-300 dark:bg-slate-900 dark:text-gray-200 font-sans flex flex-col min-h-screen">
            ...
            <div class="flex justify-between h-16 items-center">
                <a href="/" class="flex-shrink-0 flex items-center gap-2 hover:opacity-80 transition">
                    <div class="w-9 h-9 bg-kominfo flex items-center justify-center text-white font-bold text-sm">
                        <!-- Ikon Perisai SVG Pengganti Emoji -->
                ...
                <div class="flex items-center space-x-6">
                    <div class="hidden lg:flex space-x-6">
                        <a href="/" class="text-kominfo dark:text-blue-500 font-bold text-sm transition border-b-2 border-kominfo pb-1">Beranda</a>
                    ...
                    <a href="/login" class="bg-kominfo hover:bg-kominfo_dark text-white px-5 py-2 text-sm font-semibold transition shadow-sm hidden sm:block rounded-sm">Login Admin</a>
                </div>
            </div>
        </div>
    </nav>
        ...
        <header class="relative w-full min-h-[calc(100vh-64px)] flex items-center justify-center bg-slate-900 overflow-hidden">
            ...
            <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white pb-10">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    ...
                    <a href="#" class="px-8 py-3 bg-kominfo border border-kominfo text-white hover:bg-kominfo_dark hover:border-kominfo_dark transition-all duration-300 font-semibold text-sm tracking-wide rounded-sm shadow-lg shadow-kominfo/20">Lapor Insiden</a>
                </div>
            </div>
        </header>
    ...
    <!-- WIDGET CHATBOT CSIRT (Gaya Profesional Tanpa Emoji) -->
