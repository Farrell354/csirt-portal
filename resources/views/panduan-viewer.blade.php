...
<body class="bg-gray-50 text-gray-800 transition-colors duration-500 dark:bg-[#020617] dark:text-gray-200 font-sans flex flex-col min-h-screen overflow-x-hidden selection:bg-cyan-500 selection:text-white">
    ...
    <!-- KONTEN UTAMA -->
    <div class="flex-grow relative z-10 flex flex-col items-center w-full pt-8 pb-24">
        
        <div class="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            
            <!-- ================= HEADER HALAMAN & TOMBOL KEMBALI ================= -->
            <div class="relative mb-10 opacity-0 animate-fade-in-up">
                
                <!-- Tombol Kembali (Desain Ala Terminal) -->
                <a href="/panduan" class="inline-flex items-center gap-2 px-4 py-2 bg-white/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800 text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-cyan-400 text-xs font-bold tracking-widest uppercase rounded-xl backdrop-blur-md shadow-sm transition-all hover:-translate-x-1 mb-6 md:absolute md:left-0 md:top-1/2 md:-translate-y-1/2 md:mb-0 z-20">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
                    Kembali
                </a>

                <div class="text-center md:px-36">
                    <!-- Cyber Badge -->
                    <div class="inline-flex items-center gap-2.5 px-3 py-1 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-cyan-500/30 text-blue-600 dark:text-cyan-400 text-[10px] font-bold tracking-widest uppercase rounded-full backdrop-blur-md shadow-sm dark:shadow-[0_0_15px_rgba(6,182,212,0.15)] mb-4">
                    ...
                    <!-- Judul Besar Dinamis -->
                    <h1 class="font-display text-2xl md:text-3xl lg:text-4xl font-black text-slate-900 dark:text-white tracking-tight leading-tight">
                        {{ request('judul') ?? 'Dokumen Panduan Siber' }}
                    </h1>
                </div>
            </div>
            ...
            <div class="w-full opacity-0 animate-fade-in-up" style="animation-delay: 0.2s;">
                <div class="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-3xl shadow-xl dark:shadow-[0_10px_40px_rgba(0,0,0,0.5)] border border-gray-200/50 dark:border-slate-700/80 p-2 md:p-3 relative overflow-hidden group">
                    ...
                    <div class="w-full h-[70vh] md:h-[80vh] rounded-[1.25rem] overflow-hidden border border-gray-100 dark:border-slate-800 bg-gray-100 dark:bg-[#020817] relative">
                        ...
                        <!-- Loading UI (Kelihatan sekilas sebelum PDF termuat) -->
                        <div class="absolute inset-0 flex flex-col items-center justify-center -z-10 text-gray-400 dark:text-slate-600">
                            ...
                            <span class="text-xs font-mono font-bold tracking-widest uppercase">Memuat Dokumen Terenkripsi...</span>
                        </div>
