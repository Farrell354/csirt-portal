...
<body class="bg-gray-50 text-gray-800 transition-colors duration-300 dark:bg-slate-900 dark:text-gray-200 font-sans flex flex-col min-h-screen">
            ...
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex items-center space-x-6">
                    <div class="hidden lg:flex space-x-6">
                        ...
                        <a href="/profil" class="text-kominfo dark:text-blue-500 font-bold text-sm transition border-b-2 border-kominfo pb-1">Profil</a>
    ...
    <div class="flex-grow bg-white dark:bg-slate-900">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <!-- Visi/Misi -->
            <div class="mb-20">
                <h2 class="text-2xl font-bold text-slate-900 dark:text-white mb-8 border-b border-gray-200 dark:border-slate-800 pb-4">Misi Pembentukan</h2>
                
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <!-- Misi 1 -->
                    <div class="group border border-gray-200 dark:border-slate-700 p-8 bg-white dark:bg-slate-800/50 hover:border-kominfo dark:hover:border-kominfo transition-colors duration-300 relative">
                        <div class="text-6xl font-black text-gray-100 dark:text-slate-700/50 absolute top-6 right-6 pointer-events-none transition-colors group-hover:text-blue-50 dark:group-hover:text-slate-700">01</div>
                    ...
                    <!-- Misi 2 -->
                    <div class="group border border-gray-200 dark:border-slate-700 p-8 bg-white dark:bg-slate-800/50 hover:border-kominfo dark:hover:border-kominfo transition-colors duration-300 relative">
                        <div class="text-6xl font-black text-gray-100 dark:text-slate-700/50 absolute top-6 right-6 pointer-events-none transition-colors group-hover:text-blue-50 dark:group-hover:text-slate-700">02</div>
                        <div class="relative z-10">
                    ...
                    <!-- Misi 3 -->
                    <div class="group border border-gray-200 dark:border-slate-700 p-8 bg-white dark:bg-slate-800/50 hover:border-kominfo dark:hover:border-kominfo transition-colors duration-300 relative">
                        <div class="text-6xl font-black text-gray-100 dark:text-slate-700/50 absolute top-6 right-6 pointer-events-none transition-colors group-hover:text-blue-50 dark:group-hover:text-slate-700">03</div>
                        <div class="relative z-10">
            ...
            <!-- Konstituen -->
            <div class="bg-slate-900 dark:bg-slate-950 p-8 sm:p-10 border-l-4 border-kominfo shadow-xl">
