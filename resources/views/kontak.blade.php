...
<body class="bg-gray-50 text-gray-800 transition-colors duration-300 font-sans flex flex-col min-h-screen">
            ...
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex items-center space-x-6">
                    <div class="hidden lg:flex space-x-6">
                        ...
                        <a href="/kontak" class="text-kominfo font-bold text-sm transition border-b-2 border-kominfo pb-1">Kontak</a>
                    </div>
    ...
    <div class="flex-grow bg-white">
        ...
        <div class="bg-slate-50 border-b border-gray-200 py-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="max-w-3xl">
                    <h1 class="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight mb-4">Hubungi Kami</h1>
                    <p class="text-lg text-gray-600">Pusat layanan informasi, pelaporan insiden, dan koordinasi keamanan siber Provinsi Jawa Timur.</p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="space-y-10">
                    <div>
                        <h2 class="text-2xl font-bold text-slate-900 mb-6 border-b border-gray-200 pb-4">Informasi Kontak JatimProv-CSIRT</h2>
                        
                        <div class="space-y-6">
                            <!-- Alamat -->
                            <div class="flex items-start">
                                <div class="w-12 h-12 bg-gray-100 flex items-center justify-center rounded-sm mr-4 shrink-0 text-kominfo border border-gray-200">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                                </div>
                                <div>
                                    <h3 class="font-bold text-slate-900 text-base">Lokasi / Alamat</h3>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    <h3 class="font-bold text-slate-900 text-base">Surat Elektronik (Email)</h3>
                                    <p class="text-gray-600 text-sm mt-1 leading-relaxed">
                                        <a href="mailto:csirt@jatimprov.go.id" class="text-kominfo hover:underline">csirt@jatimprov.go.id</a>
                                    </p>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    <h3 class="font-bold text-slate-900 text-base">Telepon</h3>
                                    <p class="text-gray-600 text-sm mt-1 leading-relaxed">
                                        (031) 8294608
                                    </p>
                                </div>
                    ...
                    <!-- PGP Key Box -->
                    <div class="bg-slate-50 border border-gray-200 p-6 rounded-sm">
                        <div class="flex items-center gap-3 mb-4">
                            <svg class="w-6 h-6 text-kominfo" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8V7a4 4 0 00-8 0v4h8z"></path></svg>
                            <h3 class="font-bold text-slate-900">Kunci Publik PGP</h3>
                        </div>
                        ...
                        <a href="{{ asset('dokumen/PANDUAN-PENGGUNAAN-OPENPGP.pdf') }}" target="_blank" download class="inline-flex items-center justify-center px-6 py-2 border-2 border-kominfo text-kominfo hover:bg-kominfo hover:text-white font-bold text-xs uppercase tracking-widest transition-colors rounded-sm w-full sm:w-auto">
                ...
                <div class="h-full min-h-[400px]">
                    <div class="w-full h-full rounded-sm overflow-hidden border border-gray-200 shadow-sm bg-gray-100 relative">
                        <iframe 
