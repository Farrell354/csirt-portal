        ...
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center space-x-6">
                ...
                <div class="hidden lg:flex items-center space-x-6">
                    ...
                    <!-- MENU DROPDOWN DOKUMEN -->
                    <div class="relative group">
                        <!-- Tombol Induk (Dokumen) -->
                        <button class="flex items-center gap-1 {{ request()->is('rfc2350') || request()->is('panduan') ? 'text-blue-700 dark:text-blue-500 font-bold border-b-2 border-blue-700 dark:border-blue-500' : 'text-gray-700 dark:text-gray-200 hover:text-blue-700 dark:hover:text-blue-400 font-medium' }} text-sm transition pb-1 focus:outline-none">
                            Dokumen
                            <!-- Ikon Panah Bawah -->
                            <svg class="w-4 h-4 transform group-hover:rotate-180 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </button>
                        
                        <!-- Isi Dropdown (Muncul saat di-hover) -->
                        <div class="absolute left-0 pt-3 w-48 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                            <div class="bg-white dark:bg-slate-800 rounded-md shadow-lg border border-gray-200 dark:border-slate-700 py-1">
                                <!-- Link RFC2350 -->
                                <a href="/rfc2350" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-slate-700 hover:text-blue-700 dark:hover:text-blue-400 transition-colors {{ request()->is('rfc2350') ? 'font-bold text-blue-700 dark:text-blue-500' : '' }}">
                                    RFC 2350
                                </a>
                ...
                @auth
                    <div class="flex items-center gap-2">
                        ...
                        <a href="/settings" class="flex items-center gap-1 bg-slate-700/50 hover:bg-slate-700 text-gray-200 hover:text-white px-4 py-2 rounded-lg text-sm font-bold transition-all border border-slate-600">
                ...
                <!-- KONDISI JIKA USER BELUM LOGIN -->
                    <div class="flex items-center gap-2">
                        <a href="{{ route('login') }}" class="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-bold text-sm transition-colors">
                            Masuk
                        </a>
