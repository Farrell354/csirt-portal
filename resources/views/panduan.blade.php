...
<body class="bg-gray-50 text-gray-800 transition-colors duration-300 dark:bg-slate-900 dark:text-gray-200 font-sans flex flex-col min-h-screen">
            ...
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex items-center space-x-6">
                    <div class="hidden lg:flex space-x-6">
                        ...
                        <a href="/panduan" class="text-kominfo dark:text-blue-500 font-bold text-sm transition border-b-2 border-kominfo pb-1">Panduan</a>
    ...
    <div class="flex-grow bg-white dark:bg-slate-900">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <!-- Tabel Data -->
            <div class="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-sm overflow-hidden shadow-sm">
                ...
                <div class="p-4 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-800/50 flex justify-between items-center">
                    ...
                    <div class="relative">
                        <input type="text" placeholder="Cari dokumen..." class="bg-white dark:bg-slate-900 border border-gray-300 dark:border-slate-600 text-sm px-4 py-2 rounded-sm outline-none focus:border-kominfo dark:focus:border-kominfo transition-colors w-64 text-gray-700 dark:text-gray-200">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-600 dark:text-gray-300">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-slate-800 dark:text-gray-400 border-b border-gray-200 dark:border-slate-700">
                            <tr>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-slate-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-6 py-4 font-medium text-slate-900 dark:text-white">1</td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ asset('dokumen/Panduan-Penanganan-Insiden-Serangan-SQL-Injection.pdf') }}" target="_blank" download class="inline-block text-gray-400 hover:text-kominfo dark:hover:text-blue-400 transition-colors" title="Unduh File">
                            ...
                            <!-- Baris 2 -->
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-6 py-4 font-medium text-slate-900 dark:text-white">2</td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ asset('dokumen/Panduan-Penanganan-Insiden-Web-Defacement.pdf') }}" target="_blank" download class="inline-block text-gray-400 hover:text-kominfo dark:hover:text-blue-400 transition-colors" title="Unduh File">
                                        <svg class="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                    </a>
                                </td>
                            </tr>
                            <!-- Baris 3 -->
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-6 py-4 font-medium text-slate-900 dark:text-white">3</td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ asset('dokumen/Panduan-Penanganan-Insiden-Serangan-DDoS.pdf') }}" target="_blank" download class="inline-block text-gray-400 hover:text-kominfo dark:hover:text-blue-400 transition-colors" title="Unduh File">
                                        <svg class="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                    </a>
                                </td>
                            </tr>
                            <!-- Baris 4 -->
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-6 py-4 font-medium text-slate-900 dark:text-white">4</td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ asset('dokumen/Panduan-Penanganan-Insiden-Serangan-Phishing.pdf') }}" target="_blank" download class="inline-block text-gray-400 hover:text-kominfo dark:hover:text-blue-400 transition-colors" title="Unduh File">
                                        <svg class="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                    </a>
                                </td>
                            </tr>
                            <!-- Baris 5 -->
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-6 py-4 font-medium text-slate-900 dark:text-white">5</td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ asset('dokumen/Panduan-Penanganan-Insiden-Malware.pdf') }}" target="_blank" download class="inline-block text-gray-400 hover:text-kominfo dark:hover:text-blue-400 transition-colors" title="Unduh File">
                                        <svg class="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                    </a>
                                </td>
                            </tr>
                            <!-- Baris 6 -->
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-6 py-4 font-medium text-slate-900 dark:text-white">6</td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ asset('dokumen/Panduan-Penanganan-Insiden-Ransom-sign.pdf') }}" target="_blank" download class="inline-block text-gray-400 hover:text-kominfo dark:hover:text-blue-400 transition-colors" title="Unduh File">
                                        <svg class="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                    </a>
                                </td>
                            </tr>
                            <!-- Baris 7 -->
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-6 py-4 font-medium text-slate-900 dark:text-white">7</td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ asset('dokumen/Insiden Keamanan Informasi - TEMPLATE.pdf') }}" target="_blank" download class="inline-block text-gray-400 hover:text-kominfo dark:hover:text-blue-400 transition-colors" title="Unduh File">
                                        <svg class="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                    </a>
                                </td>
                            </tr>
                            <!-- Baris 8 -->
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-6 py-4 font-medium text-slate-900 dark:text-white">8</td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ asset('dokumen/Panduan-Manajemen-Risiko-Keamanan-Di-Tengah-Pandemi-COVID--19.pdf') }}" target="_blank" download class="inline-block text-gray-400 hover:text-kominfo dark:hover:text-blue-400 transition-colors" title="Unduh File">
                                        <svg class="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                    </a>
                                </td>
                            </tr>
                            <!-- Baris 9 -->
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-6 py-4 font-medium text-slate-900 dark:text-white">9</td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ asset('dokumen/PANDUAN-PENGGUNAAN-OPENPGP.pdf') }}" target="_blank" download class="inline-block text-gray-400 hover:text-kominfo dark:hover:text-blue-400 transition-colors" title="Unduh File">
                                        <svg class="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                    </a>
                                </td>
                            </tr>
                            <!-- Baris 10 -->
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-6 py-4 font-medium text-slate-900 dark:text-white">10</td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ asset('dokumen/BSSN - Panduan Menghadapi Insiden Data Breach.pdf') }}" target="_blank" download class="inline-block text-gray-400 hover:text-kominfo dark:hover:text-blue-400 transition-colors" title="Unduh File">
                                        <svg class="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                    </a>
                                </td>
                            </tr>
                            <!-- Baris 11 -->
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-6 py-4 font-medium text-slate-900 dark:text-white">11</td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ asset('dokumen/Perbaikan dan Mitigasi Insiden Website Judi Online.pdf') }}" target="_blank" download class="inline-block text-gray-400 hover:text-kominfo dark:hover:text-blue-400 transition-colors" title="Unduh File">
                                        <svg class="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                    </a>
                                </td>
                            </tr>
                            <!-- Baris 12 -->
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-6 py-4 font-medium text-slate-900 dark:text-white">12</td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ asset('dokumen/Panduan_Penanganan_Insiden_Web_Defacement_Judi_Online.pdf') }}" target="_blank" download class="inline-block text-gray-400 hover:text-kominfo dark:hover:text-blue-400 transition-colors" title="Unduh File">
                                        <svg class="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                    </a>
                                </td>
                            </tr>
                            <!-- Baris 13 -->
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-6 py-4 font-medium text-slate-900 dark:text-white">13</td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ asset('dokumen/LANSKAP ITSA 2025 (Public).pdf') }}" target="_blank" download class="inline-block text-gray-400 hover:text-kominfo dark:hover:text-blue-400 transition-colors" title="Unduh File">
                                        <svg class="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                    </a>
                                </td>
                            </tr>
                ...
                <!-- Footer Tabel -->
                <div class="p-4 border-t border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-800/50 text-xs text-gray-500 dark:text-gray-400">
