...
<body class="bg-gray-50 text-gray-800 transition-colors duration-500 dark:bg-[#020617] dark:text-gray-200 font-sans flex flex-col min-h-screen relative overflow-x-hidden selection:bg-cyan-500 selection:text-white">
    ...
    <div class="flex-grow relative z-10 pb-24 pt-16">
        ...
        <!-- Isi Konten Artikel -->
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 opacity-0 animate-fade-in-up" style="animation-delay: 0.3s;">
            ...
            <div class="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl p-8 md:p-12 rounded-3xl shadow-lg border border-gray-200/50 dark:border-slate-800/80">
                ...
                <div class="mt-16 pt-8 border-t border-gray-200 dark:border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-6">
                    <span class="text-[11px] font-mono font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest">Bagikan Intelijen Ini:</span>
                    
                    <div class="flex gap-4">
                        <button class="w-12 h-12 rounded-xl bg-gray-50 dark:bg-[#020817] flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-blue-600 hover:text-white dark:hover:bg-cyan-600 dark:hover:text-white transition-all shadow-sm border border-gray-200 dark:border-slate-700 hover:scale-110 hover:-translate-y-1">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/></svg>
                        </button>
                        <button class="w-12 h-12 rounded-xl bg-gray-50 dark:bg-[#020817] flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-blue-800 hover:text-white dark:hover:bg-blue-700 dark:hover:text-white transition-all shadow-sm border border-gray-200 dark:border-slate-700 hover:scale-110 hover:-translate-y-1">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                        </button>
                        <button class="w-12 h-12 rounded-xl bg-gray-50 dark:bg-[#020817] flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-green-500 hover:text-white dark:hover:bg-emerald-600 dark:hover:text-white transition-all shadow-sm border border-gray-200 dark:border-slate-700 hover:scale-110 hover:-translate-y-1">
