...
<body class="bg-gray-50 text-gray-800 transition-colors duration-300 dark:bg-slate-900 dark:text-gray-200 font-sans flex flex-col min-h-screen">
            ...
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex items-center space-x-6">
                    <div class="hidden lg:flex space-x-6">
                        ...
                        <a href="/artikel" class="text-kominfo dark:text-blue-500 font-bold text-sm transition border-b-2 border-kominfo pb-1">Artikel</a>
    ...
    <!-- KONTEN ARTIKEL -->
    <div class="flex-grow bg-white dark:bg-slate-900 pb-20">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
            ...
            <div class="flex items-center gap-3 mb-6">
                <span class="bg-kominfo/10 dark:bg-blue-500/10 text-kominfo dark:text-blue-400 font-bold text-xs uppercase tracking-widest px-3 py-1 rounded-sm border border-kominfo/20 dark:border-blue-400/20">
                    {{ $artikel->kategori }}
                </span>
            ...
            <div class="flex items-center gap-3 pb-8 border-b border-gray-200 dark:border-slate-800">
                <div class="w-10 h-10 bg-gray-200 dark:bg-slate-700 rounded-full flex items-center justify-center text-gray-500 dark:text-gray-300 font-bold border-2 border-white dark:border-slate-900 shadow-sm">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                </div>
                <div>
                    <p class="text-sm font-bold text-slate-900 dark:text-white">{{ $artikel->penulis }}</p>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
            <div class="w-full h-[400px] md:h-[500px] bg-gray-100 dark:bg-slate-800 rounded-sm overflow-hidden shadow-lg border border-gray-200 dark:border-slate-700">
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <article class="prose prose-lg dark:prose-invert prose-blue max-w-none prose-headings:font-bold prose-a:text-kominfo hover:prose-a:text-kominfo_dark prose-img:rounded-sm">
            ...
            <!-- Share Section -->
            <div class="mt-16 pt-8 border-t border-gray-200 dark:border-slate-800 flex items-center justify-between">
                <span class="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-widest">Bagikan Informasi:</span>
