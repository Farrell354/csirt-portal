...
<body class="bg-gray-50 text-gray-900 transition-colors duration-300 dark:bg-slate-900 dark:text-gray-200 font-sans antialiased selection:bg-blue-300">
    ...
    Hall of 
    <span class="bg-gradient-to-r from-amber-600 via-yellow-300 to-amber-600 bg-[length:200%_auto] text-transparent bg-clip-text animate-shine drop-shadow-[0_0_10px_rgba(251,191,36,0.3)]">
        Fame & Elite
    </span>
</h1>
    ...
    <div class="max-w-5xl mx-auto px-4 py-16">
        ...
        <div class="flex flex-col md:flex-row items-end justify-center gap-4 md:gap-6 mb-20 md:h-[350px]">
            ...
            <!-- JUARA 2 (Silver) -->
            @if(isset($top3[1]))
            <a href="/hunter/{{ $top3[1]->id }}" class="w-full md:w-[28%] block transform transition hover:-translate-y-2 cursor-pointer">
                <div class="bg-white rounded-[2rem] shadow-lg h-[260px] border border-gray-100 text-center relative pt-10 px-4 pb-6 flex flex-col justify-between">
            ...
            <!-- JUARA 1 (Gold) -->
            @if(isset($top3[0]))
            <a href="/hunter/{{ $top3[0]->id }}" class="w-full md:w-[36%] z-10 block transform transition hover:-translate-y-2 cursor-pointer">
                <div class="bg-gradient-to-b from-amber-50 to-white rounded-[2.5rem] shadow-2xl h-[340px] border border-amber-100 text-center relative pt-14 px-6 pb-8 flex flex-col justify-between">
            ...
            <!-- JUARA 3 (Bronze) -->
            @if(isset($top3[2]))
            <a href="/hunter/{{ $top3[2]->id }}" class="w-full md:w-[28%] block transform transition hover:-translate-y-2 cursor-pointer">
                <div class="bg-white rounded-[2rem] shadow-lg h-[240px] border border-gray-100 text-center relative pt-10 px-4 pb-6 flex flex-col justify-between">
        ...
        <div class="mt-8 mb-4">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200/60 overflow-hidden">
                <div class="divide-y divide-gray-100">
                    ...
                    <!-- INI YANG DIUBAH JADI TAG <A> -->
                    <a href="/hunter/{{ $hunter->id }}" class="flex items-center justify-between p-4 md:px-8 md:py-5 hover:bg-slate-50 transition-colors group cursor-pointer block">
                        ...
                        <div class="flex items-center gap-4 md:gap-6 w-full">
                            ...
                            <!-- Info -->
                            <div class="flex-1">
                                <div class="font-bold text-gray-900 flex items-center gap-2 group-hover:text-blue-600 transition-colors">
                                    {{ $hunter->name }}
